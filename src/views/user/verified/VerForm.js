...
class VerForm extends Component {
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit} className="ver-form">
        ...
        <FormItem {...formItemLayout} label="年龄">
          {getFieldDecorator('age', {
            rules: [
              ...
              { pattern: /^[0-9]{0,2}$/, message: '年龄不正确' }
            ]
          })(<Input size="large" placeholder="请输入年龄" />)}
        </FormItem>
        <FormItem {...formItemLayout} label="性别" className="sex-item">
