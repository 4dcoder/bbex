...
class Trade extends Component {
    ...
    openMarketsocket = () => {
        //打开市场websocket
        const marketWS = new ReconnectingWebSocket(`${WS_PREFIX}/plat`);
        ...
        marketWS.onopen = evt => {
            //console.log('market Websocket Connection open ...');
        };

        marketWS.onmessage = evt => {
            if (evt.data === 'pong') {
                //console.log('market: ', evt.data);
                return;
            }
        ...
        marketWS.onerror = evt => {
            //console.log(evt);
        };

        this.setState({ marketWS });
    };

    openStreamWebsocket = ({ coinName, marketName }) => {
        let { streamWS } = this.state;
                    ...
                    if (current - this.timer1 > 500) {
                        ...
                        if (record && record.matchStreamVO) {
                            ...
                            if (
                                ...
                                tradeExpair[marketName] = tradeExpair[
                                    marketName
                                ].map(item => {
    ...
    openBuyAndSellWebsocket = () => {
        //打开websockets
        const buyandsellWS = new ReconnectingWebSocket(
            `${WS_PREFIX}/buyAndSell`
        );
    ...
    openUserWebsocket = () => {
        //打开websockets
        const { id } = JSON.parse(sessionStorage.getItem('account'));
        const userWS = new ReconnectingWebSocket(`${WS_PREFIX}/user?${id}`);
            ...
            if (current - this.timer3 > 1000) {
                ...
                if (orderVo) {
                    ...
                    if (isNewRecord) {
                        ...
                        orderVo.successVolume =
                            orderVo.successVolume &&
                            orderVo.successVolume.toFixed(8);
                ...
                if (this.coinName) {
                    ...
                    if (json.data[this.state.market]) {
                        ...
                        this.setState({
                            ...
                            coinName:
                                json.data[Object.keys(json.data)[0]][0]
                                    .coinOther
                        });
                    }
                }
    ...
    componentWillUnmount() {
        ...
        // 关闭websocket的连接
        const { marketWS, streamWS, buyandsellWS, userWS } = this.state;
        marketWS && marketWS.close();
        streamWS && streamWS.close();
    ...
    render() {
        ...
        const orderColumns = [
            ...
            },
            {
                ...
                key: 'amount',
                render: (text, record) =>
                    (record.price * record.volume).toFixed(8)
            },
            {
                ...
                render: (text, record) => {
                    if (record.status === 2 || record.status === 3) {
                        return (
                            <Button
                                type="primary"
                                onClick={this.handleOrderDetail.bind(
                                    this,
                                    record.orderNo
                                )}
                            >
                        ...
                        return (
                            <Button
                                type="primary"
                                onClick={this.handleCancelTrade.bind(
                                    this,
                                    record.orderNo
                                )}
                            >
        ...
        if (
            ...
            tradeExpair[marketName].forEach(coin => {
                if (coin.coinOther === coinName) {
                    ...
                    currentCoin.trend =
                        currentCoin.change > 0 ? 'green' : 'red';
                }
            });
        }
                    ...
                    <div className="trade-left">
                                    ...
                                    {allTradeMarket.map(marketName => {
                                        return (
                                            <li
                                                ...
                                                onClick={this.handleSwitchMarket.bind(
                                                    this,
                                                    marketName
                                                )}
                                            >
                            ...
                            <div className="trade-plate-tit cell-3">
                                ...
                                <div className="trade-plate-tit-cell sorter">
                                    ...
                                    <div className="ant-table-column-sorter">
                                        <span
                                            className="ant-table-column-sorter-up on"
                                            title="↑"
                                        >
                                            ...
                                            <tbody>
                                                {(searchList
                                                    ...
                                                    return (
                                                        <tr
                                                            key={coin.key}
                                                            onClick={this.handleSelectCoin.bind(
                                                                this,
                                                                coin
                                                            )}
                        ...
                        <div className="trade-plate">
                            <header className="trade-plate-header">
                                <span className="trade-plate-header-text">
                                    最新成交
                                </span>
                            </header>
                            <div className="trade-plate-tit cell-3">
                                                        ...
                                                        if (stream) {
                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    ...
                                                                    <td>
                                                                        {stream.price.toFixed(
                                                                            8
                                                                        )}
                                                                    </td>
                                                                    <td>
                                                                        {stream.volume.toFixed(
                                                                            8
                                                                        )}
                                                                    </td>
                                                                </tr>
                    ...
                    <div className="trade-center">
                        <div className="trade-plate">
                            <header className="trade-plate-header">
                                ...
                                <span
                                    ...
                                    dangerouslySetInnerHTML={{
                                        __html: `${coinPrice.toFixed(
                                            8
                                        )} &asymp; ￥${toCNY.toFixed(8)}`
                                    }}
                                />
                            ...
                            <div className="trade-plate-tit Kline">
                                <div className="trade-plate-tit-cell">
                                    最高<strong>
                                        {currentCoin.highestPrice.toFixed(8)}
                                    </strong>
                                </div>
                                <div className="trade-plate-tit-cell">
                                    最低<strong>
                                        {currentCoin.lowerPrice.toFixed(8)}
                                    </strong>
                                </div>
                                <div className="trade-plate-tit-cell">
                                    成交量<strong>
                                        {currentCoin.dayCount.toFixed(8)}
                                    </strong>
                                </div>
                                <div className="trade-plate-tit-cell">
                                    涨跌幅
                                    ...
                                    {[
                                        ...
                                        return (
                                            <i
                                                ...
                                                onClick={this.handleSwitchList.bind(
                                                    this,
                                                    index
                                                )}
                                            />
                                                            ...
                                                            return (
                                                                index >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <td>
                                                                            {record.price.toFixed(
                                                                                8
                                                                            )}
                                                                        </td>
                                                                        <td>
                                                                            {record.volume.toFixed(
                                                                                8
                                                                            )}
                                                                        </td>
                                                                        {false && (
                                                ...
                                                <tbody>
                                                    {(listType === 1
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                <td
                                                                    className={`font-color-${colorName}`}
                                                                >
                                                                    {actionName}
                                                                    {index + 1}
                                                                </td>
